...
pygame.mixer.init()
pygame.mixer.music.load("resources/bgm1.mp3")
pygame.mixer.music.set_volume(0.1)
pygame.mixer.music.play()
del_music = pygame.mixer.Sound("resources/delete.mp3")
change_music = pygame.mixer.Sound("resources/change.mp3")
...
class Game():
	...
	def drawScore(self):
		if self.score >= 100:
			score_render = self.font.render('恭喜通关！', 1, (85, 65, 0))
			rect = score_render.get_rect()
			rect.left, rect.top = (55, 15)
			self.screen.blit(score_render, rect)
			with open("桑味书屋.txt", "w", encoding="utf-8") as f:
