...
Date: 2024-02-18 21:48:27
LastEditors: 狐日泽
LastEditTime: 2024-02-27 16:14:51
'''
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption('Raaaaaaaaaaaaaandom Maze') # 游戏标题
    ...
    # 加载角色照片
    user = pygame.image.load("user.jpg").convert_alpha()
